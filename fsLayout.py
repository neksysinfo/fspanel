...
def populateLayout(parent, layout, index):
    ...
    if (index == 0):
        ...
        parent.airspeed.initialize({'speed': {'vs0': 0, 'vs1': 120, 'vfe': 0, 'vno': 285, 'vne': 410, 'max': 410, 'value': 0}})
        ...
        layout.addWidget(parent.airspeed, 1, 0, Qt.AlignBottom)
        parent.airspeed.initialize({'speed': {'vs0': 85, 'vs1': 100, 'vfe': 170, 'vno': 260, 'vne': 310, 'max': 310, 'value': 0}})
